...
struct SubmapList_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::cartographer_ros_msgs::TrajectorySubmapList_<ContainerAllocator> , typename ContainerAllocator::template rebind< ::cartographer_ros_msgs::TrajectorySubmapList_<ContainerAllocator> >::other >  _trajectory_type;
...
// {'std_msgs': ['/opt/ros/kinetic/share/std_msgs/cmake/../msg'], 'cartographer_ros_msgs': ['/home/lht/robots/src/cartographer_ros/cartographer_ros_msgs/msg'], 'geometry_msgs': ['/opt/ros/kinetic/share/geometry_msgs/cmake/../msg']}
...
struct MD5Sum< ::cartographer_ros_msgs::SubmapList_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0x5b078c8c78f69121ULL;
  static const uint64_t static_value2 = 0x4539bd5c73670511ULL;
};
...
struct Printer< ::cartographer_ros_msgs::SubmapList_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cartographer_ros_msgs::SubmapList_<ContainerAllocator>& v)
  {
    ...
    for (size_t i = 0; i < v.trajectory.size(); ++i)
    {
      ...
      s << std::endl;
      s << indent;
      Printer< ::cartographer_ros_msgs::TrajectorySubmapList_<ContainerAllocator> >::stream(s, indent + "    ", v.trajectory[i]);
    }
  }
};
