...
if("TRUE" STREQUAL "TRUE")
  set(multirobot_map_merge_SOURCE_PREFIX /home/lht/robots/src/multi-robot-mapping/map_merge)
  set(multirobot_map_merge_DEVEL_PREFIX /home/lht/robots/devel)
  ...
  set(multirobot_map_merge_INSTALL_PREFIX /home/lht/robots/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'multirobot_map_merge' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lht/robots/src/multi-robot-mapping/map_merge/${idir}'.  ${_report}")
    endif()
