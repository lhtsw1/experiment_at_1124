...
if("TRUE" STREQUAL "TRUE")
  set(ca_driver_SOURCE_PREFIX /home/lht/robots/src/multi-robot-mapping/create_autonomy/ca_driver)
  set(ca_driver_DEVEL_PREFIX /home/lht/robots/devel)
  ...
  set(ca_driver_INSTALL_PREFIX /home/lht/robots/install)
...
if(NOT "/home/lht/robots/src/multi-robot-mapping/create_autonomy/ca_driver/include;/usr/local/include;/usr/include " STREQUAL " ")
  set(ca_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/lht/robots/src/multi-robot-mapping/create_autonomy/ca_driver/include;/usr/local/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ca_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lht/robots/src/multi-robot-mapping/create_autonomy/ca_driver/${idir}'.  ${_report}")
    endif()
    _list_append_unique(ca_driver_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "/usr/local/lib/libcreate.so;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libboost_thread.so;/usr/lib/x86_64-linux-gnu/libboost_chrono.so;/usr/lib/x86_64-linux-gnu/libboost_date_time.so;/usr/lib/x86_64-linux-gnu/libboost_atomic.so;/usr/lib/x86_64-linux-gnu/libpthread.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lht/robots/devel/lib;/home/lht/robots/devel/lib;/opt/ros/kinetic/lib)
