...
if("TRUE" STREQUAL "TRUE")
  set(teleop_twist_keyboard_SOURCE_PREFIX /home/lht/robots/src/multi-robot-mapping/teleop)
  set(teleop_twist_keyboard_DEVEL_PREFIX /home/lht/robots/devel)
  ...
  set(teleop_twist_keyboard_INSTALL_PREFIX /home/lht/robots/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'teleop_twist_keyboard' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lht/robots/src/multi-robot-mapping/teleop/${idir}'.  ${_report}")
    endif()
