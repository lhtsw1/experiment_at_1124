...
if("FALSE" STREQUAL "TRUE")
  set(ca_driver_SOURCE_PREFIX /home/lht/robots/src/multi-robot-mapping/create_autonomy-indigo-devel/ca_driver)
...
if(NOT "include;/usr/local/include;/usr/include " STREQUAL " ")
  set(ca_driver_INCLUDE_DIRS "")
  set(_include_dirs "include;/usr/local/include;/usr/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'ca_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/lht/robots/install/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/lht/robots/install/lib;/home/lht/robots/devel/lib;/opt/ros/kinetic/lib)
